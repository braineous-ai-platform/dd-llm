...
@QuarkusTest
public class CommitAuditServiceIT {
    ...
    void setup() {
        ...
        Console.log("CommitAuditServiceIT.setup", "dropped cr_commit_* collections");
    }

    @Test
    void getAudit_null_or_blank_returns_null() {
        assertNull(svc.getAudit(null));
        assertNull(svc.getAudit(""));
        assertNull(svc.getAudit("   "));
    }
    ...
    void getAudit_pending_when_event_or_request_present_but_receipt_missing() {
        ...
        CommitAuditView v = svc.getAudit(commitId);
        ...
        Console.log("CommitAuditServiceIT.getAudit_pending", v.getStatus().name());
    }
    ...
    void getAudit_completed_accepted_lifts_truth_surface() {
        ...
        Console.log("CommitAuditServiceIT.getAudit_completed_accepted", v.getStatus().name());
    }
    ...
    void getAudit_completed_rejected_when_receipt_accepted_false() {
        ...
        Console.log("CommitAuditServiceIT.getAudit_completed_rejected", v.getStatus().name());
    }
}
