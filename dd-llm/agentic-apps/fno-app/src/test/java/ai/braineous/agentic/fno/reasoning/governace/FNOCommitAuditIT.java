...
public class FNOCommitAuditIT {
    ...
    void setup() {
        ...
        Console.log("FNOCommitAuditIT.setup", "dropped cr_commit_* collections");
    }

    @Test
    void getAudit_null_or_blank_returns_null() {
        assertNull(audit.getAudit(null));
        assertNull(audit.getAudit(""));
        assertNull(audit.getAudit("   "));
    }

    @Test
    void getAudit_missing_all_returns_null() {
        CommitAuditView v = audit.getAudit("cr_missing");
        assertNull(v);
    }
    ...
    void getAudit_pending_when_event_present_but_receipt_missing() {
        ...
        CommitAuditView v = audit.getAudit(commitId);
